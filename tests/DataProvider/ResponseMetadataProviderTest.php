...
use Wieni\SaloonAwsXray\DataProvider\ResponseMetadataProvider;
use Wieni\SaloonAwsXray\Test\SaloonTestRequest;

class ResponseMetadataProviderTest extends TestCase
{

    public function testItAddsMetadataToTheXraySegment(): void
    {
        $dataProvider = new ResponseMetadataProvider();
